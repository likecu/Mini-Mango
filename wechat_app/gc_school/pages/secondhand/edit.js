...
Page({
  ...
  uploadimg: function (a) {
    ...
    var t = this,
      i = t.data.addedCount + a.path.length;
  ...
  upload: function () {
    ...
    for (var i = 0; i < t.length; i++) {
      ...
      wx.cloud.uploadFile({
        ...
        var e = res1.fileID;
        a.data.imgurl.push(e), console.log(a.data.imgurl), wx.hideLoading();
      }).catch((e) => {
  ...
  formSubmit: function (a) {
    ...
    var i = a.detail.value.name.replace(/\s+/g, ""),
      s = a.detail.value.oldprice.replace(/\s+/g, ""),
      o = a.detail.value.price.replace(/\s+/g, ""),
      n = a.detail.value.phone.replace(/\s+/g, ""),
      d = a.detail.value.content.replace(/\s+/g, ""),
      c = a.detail.value.stock.replace(/\s+/g, "");
